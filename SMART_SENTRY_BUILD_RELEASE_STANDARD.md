...
- One release version marker is authoritative for a build run: the highest-priority existing marker resolved by the app (`SMART_SENTRY_V3_5_2_VERSION.txt`, then older markers).
