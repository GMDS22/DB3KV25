...
MASTER_PROFILE_PRESETS = {
    ...
    "person_motion_diff": {
        "label": "Person · Motion Diff",
        "description": "Tracks person-scale targets using raw frame-difference motion only. No YOLO — any large-area movement qualifies. Best for indoor scenes with steady lighting. Detection: Frame Diff (mode 0).",
        "tooltip_key": "preset_master_person_motion_diff",
        "detection": {
            "detection_mode": 0,
            "min_contour_area": 1800.0,
            ...
            "color_fusion_strategy": "AND",
            "color_fusion_overlap": 20,
            "motion_ignore_after_move_s": 0.28,
    ...
    "person_backsub": {
        "label": "Person · Background Sub",
        "description": "Tracks person-scale targets using foreground/background separation. More stable than raw diff in slowly-changing scenes. No class lock. Detection: Background Subtraction (mode 1).",
        "tooltip_key": "preset_master_person_backsub",
        "detection": {
            "detection_mode": 1,
            ...
            "color_fusion_strategy": "AND",
            "color_fusion_overlap": 20,
            "motion_ignore_after_move_s": 0.26,
            "motion_gate_threshold": 1.2,
        },
        "filter": "sniper_large_motion",
        "threat": "balanced_guard",
        "engagement": "balanced_response",
    ...
    "person_yolo_pure": {
        "label": "Person · Pure YOLO",
        "description": "Identifies persons by YOLO class only — no motion gate so stationary people are tracked. Permissive confidence gate catches partially occluded or distant subjects. Detection: YOLO (mode 2).",
        "tooltip_key": "preset_master_person_yolo_pure",
    ...
    "person_dual_motion": {
        "label": "Person · Dual Motion",
        "description": "Requires two independent motion confirmations before locking a target. Reduces false positives in complex scenes. Person-scale size gate, no YOLO class lock. Detection: Dual Motion (mode 3).",
        "tooltip_key": "preset_master_person_dual_motion",
        "detection": {
            "detection_mode": 3,
            "min_contour_area": 1800.0,
            "max_contour_area": 50000.0,
            ...
            "color_fusion_strategy": "AND",
            "color_fusion_overlap": 20,
            "motion_ignore_after_move_s": 0.25,
            "motion_gate_threshold": 2.0,
        },
        "filter": "sniper_large_motion",
        "threat": "balanced_guard",
    ...
    "person_motion_yolo": {
        "label": "Person · Motion+YOLO",
        "description": "Motion gate triggers detection, then YOLO confirms person class. Excellent false-positive rejection for outdoor person tracking. Detection: Motion-Gated YOLO (mode 4).",
        "tooltip_key": "preset_master_person_motion_yolo",
        "detection": {
            "detection_mode": 4,
            "min_contour_area": 1500.0,
            "max_contour_area": 50000.0,
            ...
            "color_fusion_strategy": "AND",
            "color_fusion_overlap": 20,
            "motion_ignore_after_move_s": 0.15,
            "motion_gate_threshold": 2.0,
        },
        "filter": "sniper_large_person",
        "threat": "balanced_guard",
    ...
    "person_hybrid": {
        "label": "Person · Hybrid",
        "description": "Most permissive detection mode — YOLO, motion, and overlap all contribute. Best for maintaining target lock across varied conditions. Person class with closest-target priority. Detection: Best Hybrid (mode 5).",
        "tooltip_key": "preset_master_person_hybrid",
        "detection": {
            "detection_mode": 5,
    ...
    "person_color": {
        "label": "Person · Color",
        "description": "Tracks a colored target of person scale using color mask only. Tune color preset to match clothing. With 'any' color, this acts as a size-gated tracker. Detection: Color (mode 6).",
        "tooltip_key": "preset_master_person_color",
        "detection": {
            "detection_mode": 6,
    ...
    "person_color_motion": {
        "label": "Person · Color+Motion",
        "description": "Color blob fused with frame-diff motion. Person-scale blobs that match the active color and are also moving trigger tracking. Tune color to person's clothing. Detection: Color+Motion (mode 7).",
        "tooltip_key": "preset_master_person_color_motion",
        "detection": {
            "detection_mode": 7,
            "min_contour_area": 1600.0,
            "max_contour_area": 50000.0,
            "yolo_min_area": 1200,
            "yolo_confidence": 0.45,
            "color_preset": "any",
            ...
            "color_fusion_strategy": "OR",
            "color_fusion_overlap": 10,
            "motion_ignore_after_move_s": 0.20,
            "motion_gate_threshold": 0.9,
        },
        "filter": "sniper_large_motion",
        "threat": "balanced_guard",
    ...
    "person_color_backsub": {
        "label": "Person · Color+Backsub",
        "description": "Color blob fused with background subtraction foreground. Person-scale colored foreground triggers tracking. More stable than color+motion in static environments. Tune color to clothing. Detection: Color+Backsub (mode 8).",
        "tooltip_key": "preset_master_person_color_backsub",
        "detection": {
            "detection_mode": 8,
            "min_contour_area": 1600.0,
            "max_contour_area": 50000.0,
    ...
    "person_color_yolo": {
        "label": "Person · Color+YOLO",
        "description": "Color mask fused with YOLO person detection. YOLO confirms person class while color gates the region. Effective for tracking a specific person by clothing color. Detection: Color+YOLO (mode 9).",
        "tooltip_key": "preset_master_person_color_yolo",
        "detection": {
            "detection_mode": 9,
            "min_contour_area": 1600.0,
            "max_contour_area": 50000.0,
    ...
    "person_motion_locked": {
        "label": "Person · Motion-Locked",
        "description": "Filters to a single credible moving target confirmed by YOLO as person class. Ideal for high-confidence single-target person tracking with minimal false positives. Detection: Motion-Locked Filtered (mode 10).",
        "tooltip_key": "preset_master_person_motion_locked",
        "detection": {
            "detection_mode": 10,
            "min_contour_area": 1500.0,
            "max_contour_area": 50000.0,
...
"""
    ...
    def _on_engine_state_change(self, old: SentryV2State, new: SentryV2State) -> None:
        ...
        # Switch servo feedback to high-rate during ENGAGING so that
